...
import com.example.SmartWorker.Customer.DeleteJobs;
...
public class DeleteJobsAdmin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_jobs_admin);


        drawerLayout = findViewById(R.id.drawer_layout);
        navigationView = findViewById(R.id.nav_view);
        toolbar = findViewById(R.id.toolbar);
        recyclerView = findViewById(R.id.recyclerDeleteJob_admin);
            ...
            protected void onBindViewHolder(@NonNull ViewJobsHolder holder, final int position, @NonNull ViewJobsModel model) {
                ...
                holder.v.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(DeleteJobsAdmin.this, DeleteJobsSingleAdmin.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.nav_home:
                startActivity(new Intent(DeleteJobsAdmin.this,AdminDashboard.class));
                break;

            case R.id.nav_profile:
                String uid = mAuth.getCurrentUser().getUid();
                Intent intent = new Intent(DeleteJobsAdmin.this, AdminUserProfile.class);
                intent.putExtra("UserID",uid);
                startActivity(intent);
                break;
            case R.id.nav_adduser:
                startActivity(new Intent(DeleteJobsAdmin.this,RegisterAdmin.class));
                break;
