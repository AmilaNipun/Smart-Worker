...
public class DeleteJobs extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerDeleteJob);
            ...
            protected void onBindViewHolder(@NonNull ViewJobsHolder holder, final int position, @NonNull ViewJobsModel model) {
                ...
                holder.v.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(DeleteJobs.this,DeleteJobSingle.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.nav_home:
                startActivity(new Intent(DeleteJobs.this,Dashboard.class));
                break;

            case R.id.nav_profile:
                String uid = mAuth.getCurrentUser().getUid();
                Intent intent = new Intent(DeleteJobs.this, UserProfile.class);
